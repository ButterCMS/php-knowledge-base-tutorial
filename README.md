...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Create a Knowledge Base Using PHP and ButterCMS](https://buttercms.com/blog/php-knowledge-base-tutorial/), and will not be actively maintained.
